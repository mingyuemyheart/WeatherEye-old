...
//            if (dto.temperature > maxValue-itemDivider) {
//                canvas.drawText(dto.temperature + "", dto.x - tempWidth / 2, dto.y + CommonUtil.dip2px(mContext, 13f), textP);
//            }else {
                canvas.drawText(dto.temperature + "", dto.x - tempWidth / 2, dto.y - CommonUtil.dip2px(mContext, 5f), textP);
//            }
