...
//			paint.setTypeface(Typeface.create("System", Typeface.BOLD));
			float tempWidth = paint.measureText(getResources().getString(R.string.scan_text));
			canvas.drawText(getResources().getString(R.string.scan_text), (width-tempWidth)/2, (float) (frame.bottom + (float)TEXT_PADDING_TOP *density), paint);
